# Modeling competition for biomass in a constrained bioeconomy - Workshop

> Dr Fabio SPORCHIA (Aalborg University)
...
The participants will have the chance to have a look at guided examples to familiarize with it, and then directly engage with it by trying to address simple tasks, interpret the simulations results, and understand its contribution to consequential modeling.

## Agenda

+ Objective of the model (3 min)
+ Potential applications (2 min)
+ Model settings (5 min)
+ Hands on group work (25 min)
+ Q&A, futures, wrap up (10 min)

## Workflow
After a quick introduction, the workshop will include a group work session that will require people to quickly form groups. I will directly handle the group formation based on the room setting for the physical participant. Furthermore, I envision the possibility to split the virtual room also for the online participants, based on their number. Finally, we will all get back together and wrap it up.

## Materials:
Zenodo repository: [https://doi.org/10.5281/zenodo.19677137](https://doi.org/10.5281/zenodo.19677137).
(to be found in the server under the [biomod](biomod) directory)

And the [csv file "start_matrix_with_exp.csv"](start_matrix_with_exp.csv) from this repository 

## Requirements:
Laptops capable of running jupyter notebooks.
