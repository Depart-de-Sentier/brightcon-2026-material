# Collaborating on open data and Open Collaboration on the BAFU:2025+ LCA Databases

Switzerland's Federal Office for the Environment FOEN/BAFU/OFEV/UFAM published an "ecoinvent alike" open LCA Database in December 2025. It is planned to have a yearly regular update of the database. It has a focus on Switzerland but includes “RoE”, “RER”, “RoW” and “GLO” datasets as well. So far the official versions are published in ecospold1 and OpenLCA's zolca format. The OpenLCA version includes characterisation factors for IPCC 2021 GWP100, Ecological Scarcity and EF 3.1. The database is published under non-standard, BAFU specific terms of use (which are in parts similar to CC BY-(NC)-SA). Overall it is a convenient starting point for an open LCA background database and allows for community collaboration to increase its quality and coverage (sectors, technologies, geography).

There is already a lot of BAFU related work going on in the open community - mostly separated in silos (?). Let us try to make these known to each other.
...
- (10 min.) retrieval augmentation input: A Collaborative Systematic Review of LCA data formats: Benefits, Limitations, and Silos (Robin Dethienne, Université catholique de Louvain)

- (10 min.) retrieval augmentation input: The BAFU LCA Database: Origin and perspectives (Pierryves Padey, FOEN/BAFU/OFEV/UFAM)

- (30 min.) Discussion in break-out groups, see details below

- (15 min.) Plenum Wrap Up



## Break-out discussions (30 min.)
