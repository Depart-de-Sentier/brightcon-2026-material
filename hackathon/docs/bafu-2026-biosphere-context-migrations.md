...
The focused tests use the installed bw2io migration strategies and cover filename isolation, cleanup on errors, source CAS restrictions, stale links, and idempotence. Run them in `bw` from the repository root:
